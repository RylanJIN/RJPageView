...
@implementation UIView (RJAutoLayout)
...
- (NSArray *)constraintsTop:(CGFloat)top FromView:(UIView *)view
{
    ...
    return [NSLayoutConstraint constraintsWithVisualFormat:@"V:[view]-(top)-[selfView]"
                                                   options:0
                                                   metrics:@{@"top":@(top)}
                                                     views:NSDictionaryOfVariableBindings(view, selfView)];
}
...
- (NSArray *)constraintsBottom:(CGFloat)bottom FromView:(UIView *)view
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    UIView *selfView = self;
    return [NSLayoutConstraint constraintsWithVisualFormat:@"V:[selfView]-(bottom)-[view]"
                                                   options:0
                                                   metrics:@{@"bottom":@(bottom)}
                                                     views:NSDictionaryOfVariableBindings(selfView, view)];
}
...
- (NSArray *)constraintsLeft:(CGFloat)left FromView:(UIView *)view
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    UIView *selfView = self;
    return [NSLayoutConstraint constraintsWithVisualFormat:@"H:[selfView]-(left)-[view]"
                                                   options:0
                                                   metrics:@{@"left":@(left)}
                                                     views:NSDictionaryOfVariableBindings(selfView, view)];
}
...
- (NSArray *)constraintsRight:(CGFloat)right FromView:(UIView *)view
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    UIView *selfView = self;
    return [NSLayoutConstraint constraintsWithVisualFormat:@"H:[view]-(right)-[selfView]"
                                                   options:0
                                                   metrics:@{@"right":@(right)}
                                                     views:NSDictionaryOfVariableBindings(view, selfView)];
}
...
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    return @[[self constraintHeightEqualToView:view],
...
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    return @[[self constraintHeight:size.height],
...
- (NSArray *)constraintsFillWidth
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    UIView *selfView = self;
    return [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-0-[selfView]-0-|"
                                                   options:0
                                                   metrics:nil
...
- (NSArray *)constraintsFillHeight
{
    self.translatesAutoresizingMaskIntoConstraints = NO;
    UIView *selfView = self;
    return [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[selfView]-0-|"
                                                   options:0
                                                   metrics:nil
                                                     views:NSDictionaryOfVariableBindings(selfView)];
}
